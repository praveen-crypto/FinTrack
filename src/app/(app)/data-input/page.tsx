          ...
          <CardContent className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
              ...
              <div>
                ...
                <Input id="feAmount" type="number" placeholder="e.g., 1200" value={currentFixedExpense.amount} onChange={e => setCurrentFixedExpense({...currentFixedExpense, amount: e.target.value})} className="mt-1"/>
              </div>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
              ...
              <div>
                ...
                <Input id="sgAmount" type="number" placeholder="e.g., 500" value={currentSavingsGoal.amount} onChange={e => setCurrentSavingsGoal({...currentSavingsGoal, amount: e.target.value})} className="mt-1"/>
              </div>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div><Label htmlFor="emiPrincipal">Principal ($)</Label><Input id="emiPrincipal" type="number" placeholder="e.g., 15000" value={currentEmi.principal} onChange={e => setCurrentEmi({...currentEmi, principal: e.target.value})} className="mt-1"/></div>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div><Label htmlFor="emiMonthlyInstallment">Monthly Installment ($)</Label><Input id="emiMonthlyInstallment" type="number" placeholder="e.g., 475" value={currentEmi.monthlyInstallment} onChange={e => setCurrentEmi({...currentEmi, monthlyInstallment: e.target.value})} className="mt-1"/></div>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
